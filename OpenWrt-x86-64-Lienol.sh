...
# sed -i 's#page = entry({"admin", "network"#page = entry({"admin", "control"#g' package/OpenAppFilter/luci-app-oaf/luasrc/controller/appfilter.lua #更换应用控制菜单位置
# sed -i 's#admin/network/user_status#admin/control/user_status#g' package/OpenAppFilter/luci-app-oaf/luasrc/view/admin_network/user_status.htm #更换应用控制菜单位置
