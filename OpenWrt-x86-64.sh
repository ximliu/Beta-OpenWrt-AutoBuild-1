...
sed -i 's#entry({"admin", "services", "openclash"}#entry({"admin", "vpn", "openclash"}#g' package/openclash/luci-app-openclash/files/usr/lib/lua/luci/controller/openclash.lua #更换OpenClash菜单
